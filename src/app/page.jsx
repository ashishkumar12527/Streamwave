...
export default function Home() {
  return (
    <div>
      <section className="sr-only" aria-label="Streamwave music streaming">
        <h1>Streamwave Music - Free Music Streaming and MP3 Download</h1>
        <p>
          Streamwave is a free music streaming app for Bollywood, Hindi, Punjabi,
