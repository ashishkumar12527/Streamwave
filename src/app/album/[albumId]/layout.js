...
export async function generateMetadata({ params }) {
  ...
  if (!albumData) {
    return {
      title: "Album",
      description: "Listen to this album on Streamwave",
    };
  }
  ...
  return {
    ...
    description: `Listen to ${albumName} by ${artistNames}. ${songCount} songs. Download and stream ${albumName} album for free on Streamwave. Released in ${year}.`,
    keywords: [
      albumName,
      artistNames,
      `${albumName} album`,
    ...
    openGraph: {
      title: `${albumName} by ${artistNames} | Streamwave`,
